export const de = {
  ...
  home: {
    hero: {
      title: 'Finden Sie Ihre Traumimmobilie in Vietnam',
      subtitle: 'Entdecken Sie Luxusvillen, moderne Wohnungen und erstklassige Gewerbeflächen in ganz Vietnam',
      search: { title: 'Immobiliensuche', propertyType: 'Immobilientyp', location: 'Lage', button: 'Suchen', placeholder: 'Nach Lage oder Typ suchen' }
    },
    featured: { title: 'Empfohlene Objekte', subtitle: 'Unsere Premium-Auswahl', viewAll: 'Alle ansehen' },
    categories: {
      title: 'Nach Typ stöbern',
      subtitle: 'Durchsuchen Sie unseren Katalog, um die ideale Immobilie zu finden',
      apartment: { title: 'Wohnung', description: 'Moderne Räume mit Aussicht', count: '234 Objekte' },
      villa: { title: 'Villa', description: 'Luxushäuser mit Pool', count: '234 Objekte' },
      house: { title: 'Haus', description: 'Ideal für Familien', count: '234 Objekte' },
  ...
  about: { title: 'Über uns', subtitle: 'Ihr vertrauenswürdiger Immobilienpartner in Vietnam', intro: { title: 'Wer wir sind', description: 'Führende Agentur in Vietnam, spezialisiert auf Luxusimmobilien, Wohnungen und Gewerbeflächen.' }, mission: { title: 'Unsere Mission', description: 'Hervorragenden Service mit Integrität und Professionalität bieten.' }, values: { title: 'Unsere Werte', items: [ { title: 'Integrität', description: 'Hohe ethische Standards' }, { title: 'Exzellenz', description: 'Qualität in jedem Detail' }, { title: 'Kundenorientierung', description: 'Ihre Ziele haben Priorität' }, { title: 'Innovation', description: 'Moderne Technologien und Methoden' } ] }, team: { title: 'Unser Team', subtitle: 'Lernen Sie unsere Experten kennen', description: 'Ein Team von Profis, das Sie unterstützt.' } },
  ...
  advancedFilter: {
    ...
    sizeFrom: 'Größe von',
    location: 'Standort',
    bedsAny: 'Schlafzimmer: Beliebig',
    bathsAny: 'Badezimmer: Beliebig',
    rooms: 'Zimmer',

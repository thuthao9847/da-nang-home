...
export const ko = {
  ...
  home: {
    hero: {
      title: '다낭에서 꿈의 집을 찾아보세요',
      subtitle: '럭셔리 빌라, 모던 아파트, 최고의 상업 공간을 만나보세요',
      search: {
        title: '매물 검색',
        propertyType: '매물 유형',
        location: '지역',
  ...
  rent: {
    title: '매물 임대',
    subtitle: '다낭에서 이상적인 임대 매물을 찾아보세요',
    filters: { title: '필터', propertyType: '매물 유형', location: '지역', allProperties: '전체 매물', allLocations: '전체 지역' },
    noResults: '조건에 맞는 매물이 없습니다.',
  ...
  about: {
    title: '회사 소개',
    subtitle: '다낭의 신뢰받는 부동산 파트너',
    intro: { title: '회사 소개', description: '우리는 다낭 최고의 부동산 중개사로서, 럭셔리 주택, 아파트 및 상업용 부동산에 특화되어 있습니다.' },
  ...
  properties: { title: '추천 매물', subtitle: '다낭의 프리미엄 매물', viewDetails: '자세히 보기', beds: '침실', baths: '욕실', area: 'm²' },

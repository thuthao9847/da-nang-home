...
export const ru = {
  ...
  home: {
    hero: {
      title: 'Найдите недвижимость мечты во Вьетнаме',
      subtitle: 'Откройте для себя объекты по всему Вьетнаму: роскошные виллы, современные квартиры и коммерческие помещения',
      search: {
    ...
    howWeHelp: {
      ...
      rating: 'Оценка',
      selling: 'Продажа',
      affordTitle: 'Оцените бюджет',
      affordDescription: 'Поможем оценить бюджет и сохранить его в вашем профиле покупателя.',
      costsTitle: 'Понимайте ежемесячные расходы',
      costsDescription: 'Рассчитайте ипотеку и другие жилищные расходы.',
      paymentTitle: 'Помощь с первоначальным взносом',
      paymentDescription: 'Узнайте о программах поддержки и вариантах финансирования.',
      learnMore: 'Подробнее',
      spotlightText: 'Хотите выделить уникальный объект с профессиональным маркетингом?',
      letsChat: 'Свяжемся',
      steps: {
  ...
  sale: {
    ...
    subtitle: 'Найдите недвижимость мечты во Вьетнаме',
    filters: {
      title: 'Фильтры',
      propertyType: 'Тип недвижимости',
      location: 'Район',
  ...
  rent: {
    ...
    subtitle: 'Подберите идеальное жилье во Вьетнаме',
    filters: {
      title: 'Фильтры',
      propertyType: 'Тип недвижимости',
      location: 'Район',
  ...
  about: {
    title: 'О нас',
    subtitle: 'Ваш надежный партнер по недвижимости во Вьетнаме',
    intro: {
      title: 'Кто мы',
      description: 'Мы ведущее агентство недвижимости во Вьетнаме. Специализируемся на премиальной жилой и коммерческой недвижимости и помогаем клиентам находить идеальные объекты.'
    },
  ...
  properties: {
    title: 'Избранные объекты',
    subtitle: 'Подборка премиальной недвижимости по всему Вьетнаму',
    viewDetails: 'Подробнее',
    beds: 'спальни',
    baths: 'санузлы',
    area: 'м²'
